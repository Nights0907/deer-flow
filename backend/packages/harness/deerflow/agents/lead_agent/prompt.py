...
def get_student_profile_prompt_section(agent_name: str | None, student_id: str | None = None) -> str:
    ...
    return (
        ...
        "When the current question is clearly similar to a prior question recorded in Recent Sessions, mention that the student asked a similar question before and connect the current explanation to that prior practice naturally. "
        ...
        "If no student profile exists yet, continue normally and create/update it later using `update_student_profile` when you learn stable weak knowledge points, weak ability points, learning preferences, student name, grade, or subject.\n"
